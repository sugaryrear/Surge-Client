...
public class RSInterface {
	...
	public static void hoverButton10(int id, String tooltip, int enabledSprite, int disabledSprite, String buttonText,
									 TextDrawingArea tda[], int idx, int colour, int hoveredColour, boolean centerText, String spriteName) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = 1;
		tab.parentID = id;
...
//		tab.disabledSprite = Client.spriteCache.get(enabledSprite);
		...
		tab.sprite1 = imageLoader(disabledSprite, spriteName);
		tab.sprite2 = imageLoader(enabledSprite, spriteName);
	...
	public static void unpack(FileArchive streamLoader, TextDrawingArea textDrawingAreas[],
		...
		interfaceCache = new RSInterface[j + 120000];
	...
	public static void hoverButton(int id, String tooltip, int enabledSprite, int disabledSprite, String buttonText,
								   int idx, int colour, int hoveredColour, boolean centerText, String dir) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = 1;
		tab.type = TYPE_HOVER;
		...
		tab.active = false;
		tab.toggled = false;
		tab.rsFont = RSInterface.newFonts[idx];
		tab.aString228 = "";
		tab.textColor = colour;
		tab.anInt216 = hoveredColour;
		tab.centerText = centerText;
	...
	public static void runePouch2(TextDrawingArea[] tda) {
		final int START_ID = 29875;
		int id = START_ID;
		int child = 0;
	...
	public static void addHoverText(int id, String text, String tooltip, TextDrawingArea[] tda, int idx, int color, boolean center, boolean textShadow, int width, int height, int hoveredColor) {
		...
		rsinterface.anInt216 = hoveredColor;
		rsinterface.anInt239 = 0;
		rsinterface.tooltip = tooltip;
	}
	public static void addHoverText(int id, String text, String tooltip, TextDrawingArea[] font, int idx, int color, boolean center, boolean textShadow, int width, int hoveredColor) {
		RSInterface rsinterface = addInterface(id);
		rsinterface.id = id;
		rsinterface.parentID = id;
		rsinterface.type = 4;
		...
		rsinterface.centerText = center;
		rsinterface.textShadow = textShadow;
		rsinterface.textDrawingAreas = font[idx];
		rsinterface.message = text;
		rsinterface.aString228 = "";
		rsinterface.textColor = color;
		rsinterface.secondaryColor = 0;
	...
	public static void closeButtonSmall(int id) {
		RSInterface tab = addInterface(id);
		tab.atActionType = 1;
		tab.parentID = id;
		tab.tooltip = "Close";//
		tab.type = TYPE_HOVER;//9
		tab.sprite2 = 	imageLoader(0, "/Interfaces/buttons/close");
		tab.sprite1 =  	imageLoader(1, "/Interfaces/buttons/close");
		...
		tab.toggled = false;
		tab.aByte254 = (byte) 0;
		RSInterface.rsFont = RSInterface.newFonts[1];
		tab.mOverInterToTrigger = 52;
		tab.spriteOpacity = 255;
	}
	public static void closeButtonLarge(int id) {
		RSInterface tab = addInterface(id);
		tab.atActionType = 1;
		tab.parentID = id;
		tab.tooltip = "Close";//
		tab.type = TYPE_HOVER;//9
		tab.sprite2 = 	imageLoader(2, "/Interfaces/buttons/close");
		tab.sprite1 =  	imageLoader(3, "/Interfaces/buttons/close");
	...
	public static void closeButtonLarge_new(int id) {
		RSInterface tab = addInterface(id);
		tab.atActionType = 1;
		tab.parentID = id;
		tab.tooltip = "Close";//
		tab.type = TYPE_HOVER;//9
		tab.sprite2 = 	imageLoader(815, "/Interfaces/buttons/close");
		tab.sprite1 =  	imageLoader(816, "/Interfaces/buttons/close");
	...
	public static void configButton_new(int id, String tooltip, int enabledSprite, int disabledSprite, int configId, int configState) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = OPTION_OK;
		tab.type = 5;
		...
		tab.anIntArray212 = new int[1];
		tab.anIntArray245[0] = 1;
		tab.anIntArray212[0] = configState;
		tab.scripts = new int[1][3];
		tab.scripts[0][0] = 5;
		tab.scripts[0][1] = configId;
		tab.scripts[0][2] = 0;
...
//		addSprite(35001, 1, "Interfaces/safeBox/BACKGROUND");
		//addSpriteFromCache(35001, 559);
		addSprite(35001, 1, "interfaces/depositbox/BACKGROUND");
		...
		//addHoverButtonFromCache(35008, "Interfaces/Clan Chat/plus", 150, 21, 21, "Add more slots", 201, 35008, 5);


//	//	hoverButton_fromfile(35002, "", i % 2 == 0 ? 2075 : 2076, hoverinterface, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "interfaces/newtele/SPRITE");

		closeButtonSmall(35002);
		addText(35003, "Deposit Box", wid, 2, 0xFF981F, false, true);
		addText(35004, "", wid, 0, 0xFF981F, false, true);
		addText(35005, "0/50", wid, 3, 0xFF981F, false, true);
		addText(35009, "Add more slots", wid, 0, 0xFFFFFF, false, true);
		setChildren(12, tab);
		setBounds(35001, 80, 50, 0, tab);
		setBounds(35002, 403,56, 1, tab);
		setBounds(35003, 2050, 66, 2, tab);
		setBounds(35004, 160, 82, 3, tab);
		setBounds(35005, 2450, 110, 4, tab);
		setBounds(35006, 115, 95, 5, tab);
		setBounds(35008, 3300, 113, 6, tab);
		setBounds(35009, 3000, 100, 7, tab);
		setBounds(35010, 9990, 0, 8, tab);
//		hoverButton10(42109, "Deposit Inventory", 1, 2, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/BANK");
//		hoverButton10(42110, "Deposit Equipment", 3, 4, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/BANK");
//		hoverButton10(42111, "Deposit Looting Bag", 1, 1, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/LOOTBAG");
//		hoverButton10FromCache(42109, "Deposit Inventory", 560,561, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/BANK");
//		hoverButton10FromCache(42110, "Deposit Equipment", 562,563, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/BANK");
//		hoverButton10FromCache(42111, "Deposit Looting Bag", 564,564, "", RSInterface.newFonts[1], 16711680, 0xffffff, false,"/Interfaces/safeBox/LOOTBAG");


		hoverButton_fromfile(42109, "Deposit Inventory", 17,17, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "interfaces/depositbox/SPRITE");
		hoverButton_fromfile(42110, "Deposit Equipment", 19,19, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "interfaces/depositbox/SPRITE");
		hoverButton_fromfile(42111, "Deposit Looting Bag", 21,21, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "interfaces/depositbox/SPRITE");


		setBounds(42109, 160,255, 9, tab);
		setBounds(42110, 230, 255, 10, tab);
		setBounds(42111, 300, 255, 11, tab);
...
//		addHoverButton(35015, "Interfaces/Ironman/IMAGE", 3, 21, 21, "No", 201, 35013, 5);
		darken(35013, 250, 210, 0x000000, (byte) 126);	darken(35015, 250, 210, 0x000000, (byte) 126);
	//	addHoverButtonFromCache(35013, "Interfaces/Ironman/IMAGE", 488, 21, 21, "Yes", 201, 35013, 5);
		//addHoverButtonFromCache(35015, "Interfaces/Ironman/IMAGE", 487, 21, 21, "No", 201, 35013, 5);
		...
		// Item container
		addToItemGroup(35007, 7, 4, 9, 9, false, null, null, null);
		setBounds(35007, 0, 0, 0, scroller);
	}

	public static void newFriendsList(TextDrawingArea[] tda) {
		RSInterface friendstab = addTabInterface(50650);
		setChildren(2,friendstab);

		RSInterface originalfriends = interfaceCache[5065];

		setBounds(5065, 0, 0, 0, friendstab);
		setBounds(5067, 15, 2, 1, originalfriends);

		//addButton(59006, 1703, "/Interfaces/friendslist/SPRITE", "Toggle @lre@ Ignore list");
	//	addButtonFromCache(59006, 449, "/Interfaces/friendslist/SPRITE", "Toggle @lre@ Ignore list");
		addButton(59006, 1884, "Interfaces/friendslist/SPRITE", "Toggle Ignore list");
		setBounds(59006, 165, 0, 1, friendstab);


		RSInterface ignoretab = addTabInterface(50651);
		setChildren(2,ignoretab);

		RSInterface originalignore = interfaceCache[5715];

		setBounds(5717, 15, 2, 1, originalignore);
		setBounds(5715, 0, 0, 0,ignoretab);


		addButton(59007, 1885, "Interfaces/friendslist/SPRITE", "Toggle Friends list");
		setBounds(59007, 165, 0, 1, ignoretab);

	}
	public static void newWepSideBar(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29764);
		RSInterface bow = interfaceCache[1764];
		setChildren(2, p);
		addText(19995, "Category: Bow", tda, 0, 0xff9b00, true, true);

		setBounds(1764, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar1(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29765);
		RSInterface bow = interfaceCache[ 12290];
		setChildren(2, p);
		addText(19995, "Category: Whip", tda, 0, 0xff9b00, true, true);

		setBounds(12290, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar2(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29766);
		RSInterface bow = interfaceCache[5855];
		setChildren(2, p);
		addText(19995, "Category: Unarmed", tda, 0, 0xff9b00, true, true);

		setBounds(5855, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar3(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29767);
		RSInterface bow = interfaceCache[328];
		setChildren(2, p);
		addText(19995, "Category: Staff", tda, 0, 0xff9b00, true, true);

		setBounds(328, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar4(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29768);
		RSInterface bow = interfaceCache[4446];
		setChildren(2, p);
		addText(19995, "Category: Dart", tda, 0, 0xff9b00, true, true);

		setBounds(4446, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar5(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29769);
		RSInterface bow = interfaceCache[2276];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(2276, 0, 0, 0, p);
		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar6(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29770);
		RSInterface bow = interfaceCache[1698];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(1698, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar7(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29771);
		RSInterface bow = interfaceCache[8460];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(8460, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar13(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29772);
		RSInterface bow = interfaceCache[28500];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(28500, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar8(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29773);
		RSInterface bow = interfaceCache[4679];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(4679, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar23(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29786);
		RSInterface bow = interfaceCache[776];
		setChildren(2, p);
		addText(19995, "Category: Scythe", tda, 0, 0xff9b00, true, true);

		setBounds(776, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar9(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29774);
		RSInterface bow = interfaceCache[3796];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(3796, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar10(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29775);
		RSInterface bow = interfaceCache[425];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(425, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar11(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29776);
		RSInterface bow = interfaceCache[7762];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(7762, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar12(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29777);
		RSInterface bow = interfaceCache[2423];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(2423, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}
	public static void newWepSideBar14(TextDrawingArea[] tda){
		RSInterface p = addTabInterface(29778);
		RSInterface bow = interfaceCache[5570];
		setChildren(2, p);
		addText(19995, "Category: Dagger", tda, 0, 0xff9b00, true, true);

		setBounds(5570, 0, 0, 0, p);

		setBounds(19995, 100, 240, 1, p);
	}

	public static void pakYak(TextDrawingArea[] tda) {
		RSInterface rsi = addTabInterface(35342);
...
//		addHoverText(39347, "Bank All", "Bank all items", tda, 0, 0xff9040, false, true, 40);
		addText(45346, "Yak Storage", tda, 2, 0xFF9900, true, true);

//		addItemContainer(95349, 4, 7, 8, 0, true,
//				"Remove 1", "Remove 5", "Remove 10", "Remove All", "Remove X");
		addSprite(45348, 2016, "interfaces/packyak/SPRITE");
		closeButtonLarge(45347);
		//addToItemGroup(45349, 7, 4, 9, 9, true, "Withdraw", null, null);
		addItemContainer(45349, 5,5, 9, 9, true,
				"Withdraw 1", "Withdraw 5", "Withdraw 10", "Withdraw All", "Withdraw X");
		rsi.totalChildren(4);
		int child = 0;

		rsi.child(child++, 45348, 130,80);// bg
		rsi.child(child++, 45347, 348,86);// close button
		rsi.child(child++, 45346, 250,88); // title
		rsi.child(child++, 45349, 160,120); // item container

	}
	public static void pakYakAdd(TextDrawingArea[] tda) {
		RSInterface rsi = addTabInterface(95000);
	...
	//	addHoverButton(39446, "/Interfaces/Lootingbag/CLOSE", 0, 128, 35, "Close", 0, 36484, 1);
		...
		hoverButton_fromfile(95446, "", 0, 1, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "/Interfaces/Lootingbag/CLOSE");



		addItemContainer(95448, 4, 7, 8, 0, true,
				"Store 1", "Store 5", "Store 10", "Store All", "Store X");
...
//		rsi.child(child++, 39445, 90, 4);// title
		rsi.child(child++, 95446, 167, 4); // close button
//		rsi.child(child++, 39447, 167, 4); // close hover
		rsi.child(child++, 95448, 16, 27); // item container
	}
	...
	public static RSInterface addItemContainer(int childId, int width, int height, int invSpritePadX,
		...
		if (addPlaceholderItems) {
			for (int index = 0; index < rsi.inventoryItemId.length; index++) {
				rsi.inventoryItemId[index] = 4152 + (index * 2);//default items lol
...
//3214 = the inventory.
	...
	public static void addArceuus3RunesSmallBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
											  int rune2, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	public static void addSpellwithoutrunes(int ID,  int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
		rsInterface.type = 5;
		...
		rsInterface.anIntArray212 = new int[4];
		rsInterface.anIntArray245[0] = 3;
		rsInterface.anIntArray212[0] = 557;//doesnt matter the number
		rsInterface.anIntArray245[1] = 3;
		rsInterface.anIntArray212[1] = 557;
		rsInterface.anIntArray245[2] = 3;
		rsInterface.anIntArray212[2] = 557;
		rsInterface.anIntArray245[3] = 3;
		rsInterface.anIntArray212[3] = lvl;
...
//		rsInterface.scripts[1] = new int[4];
//		rsInterface.scripts[1][0] = 4;
//		rsInterface.scripts[1][1] = 3214;//3214 is ur inventory id! all its doing is checking if the rune is in that array!
//		rsInterface.scripts[1][2] = r2;
//		rsInterface.scripts[1][3] = 0;
//		rsInterface.scripts[2] = new int[4];
//		rsInterface.scripts[2][0] = 4;
...
//		rsInterface.scripts[3][2] = 0;
		...
		RSInterface INT = addInterface(ID + 1);
		INT.isMouseoverTriggered = true;//so thats what it does lol when u hover over it it displays the box!
		INT.mOverInterToTrigger = -1;
		setChildren(3, INT);
		addLunarSprite(ID + 2, 0, "BOX");
		setBounds(ID + 2, 0, 0, 0, INT);
...
//		setBounds(ID + 7, 145, 66, 8, INT);
	...
	public static void addSpellLarge2Runes(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
									  int rune2, int rune3, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int spellUsableOn, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	//	setBounds(rune3, 130, 61, 5, INT);
		addRuneText(ID + 5, ra1, r1, TDA);
		setBounds(ID + 5, 26, 92, 5, INT);
		addRuneText(ID + 6, ra2, r2, TDA);
		setBounds(ID + 6, 87, 92, 6, INT);
		//addRuneText(ID + 7, ra3, r3, TDA);
		//setBounds(ID + 7, 142, 92, 8, INT);
	}
...
//	}
	...
	public static RSInterface addNPCHead(int id) {
		RSInterface npcWidget = interfaceCache[id] = new RSInterface();
		npcWidget.id = id;
		npcWidget.parentID = id;
		npcWidget.width = 140;
		npcWidget.height = 153;
		npcWidget.type = 6;
		npcWidget.contentType = 0;
		npcWidget.model_cat = 2;//anint233
		npcWidget.modelid = 1;
		npcWidget.seq_id = -1;//anint257
		npcWidget.active_seq_id = -1;// anint258
		npcWidget.modelZoom = 796;
		npcWidget.modelRotation1 = 40;
		npcWidget.modelRotation2 = 1882;
		return npcWidget;
	}
	...
	public static void hoverButton_fromfile(int id, String tooltip, int enabledSprite, int disabledSprite, String buttonText,
											RSFont tda, int colour, int hoveredColour, boolean centerText, String name) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = 1;
		tab.type = TYPE_HOVER;
		tab.sprite2 = imageLoader(enabledSprite, name);
		tab.sprite1 = imageLoader(disabledSprite, name);
	...
	public static RSInterface addShopButtonInterface(int id, String text, int configval) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;// 250
		tab.parentID = id;// 236
		tab.type = 0;// 262
		...
		addText(id+2, text, defaultTextDrawingAreas,0, 0xFFFFFF, true, true);
		setBounds(id+1, 0,0, 0, tab);
		setBounds(id+2, interfaceCache[id+1].width/2, 5, 1, tab);
		return tab;
	}
	...
	public Model get_if_model(AnimationDefinition seq, int primary_index, boolean active) {
		Model model;
		if (active)
			model = get_model(active_model_cat, active_modelid);//yes its active.
		else
