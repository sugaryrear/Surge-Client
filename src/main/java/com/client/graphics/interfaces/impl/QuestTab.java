...
public class QuestTab extends RSInterface {
    ...
    private static void setContainer(Button button) {
        ...
        container.width = button.scrollMax != 0 ? 177 : DEFAULT_CONTAINER_WIDTH + 25;
        ...
        if (button == Button.DIARIES) { // Gotta do some stuff here that doesn't jive with the others
            ...
            containerChild.height = 162;
            containerChild.scrollMax = 320;
            master.scrollMax =  320;

            master.children[smallBoxChildId] = RSInterface.emptyInterface;
            RSInterface theinside2 = interfaceCache[24510];//yes.
            theinside2.scrollMax = 320;
            theinside2.width = 160;
