...
public class SlayerRewards extends RSInterface
{
    ...
    public static void initializeInterfaces(TextDrawingArea[] tda) {
        ...
        addHoverText(BUY_BUTTON, "Rewards", "Rewards", tda, 0, 0xFF9900, true, true, 82, 16);
       ...
       // addHoveredButton2(CLOSE_BUTTON_2, "Slayer interface/CLOSE", 2, 21, 21, CLOSE_BUTTON_2 + 1);
        closeButtonLarge(CLOSE_BUTTON_2);
    ...
    public static void infoInterface(TextDrawingArea[] tda) {
        ...
        rsinterface.child(1, CLOSE_BUTTON_1, 4720, 27);
    ...
    public static void unlockInterface(TextDrawingArea[] tda) {
        ...
        rsinterface.child(7, BUY_BUTTON, 228-19-12, 61);
        rsinterface.child(8, TASK_BUTTON, 308-14-12, 61);
//the hovered version of an unlock is +1000 of the id! so 20 will be 1020 for hovered version
        Object[][] unlocks = {
                {20, false}, // imbue slayer helmet
                {6, true}, // malevolent masquerade
                {17, true}, // bigger and badder
                {5, true}, // broad bolt fletching
                {1337, true}, // unlock curses
        };
...
//        int scrollExtension = unlocks.length >= 6 ? (((int) Math.ceil((unlocks.length - 6) / 2d)) * 64) : 0;
        int scrollExtension = unlocks.length * 52;
        scrollInterface.scrollMax = scrollExtension;
        int x, y;
        int childrenCount = 0;
...
hoverButton_fromfile(interfaceId++, "Select", (int)unlocks[index][0],(int)unlocks[index][0]+1000, "", RSInterface.newFonts[1], 0xff981f, 0xffffff, true, "Slayer interface/newunlocks/unlock");

            scrollInterface.child(child++, interfaceId, x + 6, y+1000);
