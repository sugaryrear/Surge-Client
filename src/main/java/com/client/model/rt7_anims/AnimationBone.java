...
public class AnimationBone {
   ...
   public AnimationBone(int frame_count, Buffer packet, boolean compact) {
      this.parent_id = packet.get_short();
      ...
      for(int frame_id = 0; frame_id < this.local_matrix.length; ++frame_id) {
         ...
         this.bone_vertices[frame_id][0] = packet.get_float();
         this.bone_vertices[frame_id][1] = packet.get_float();
         this.bone_vertices[frame_id][2] = packet.get_float();
      }
