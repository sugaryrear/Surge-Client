...
public class AnimationKeyFrame {
   ...
   public int deserialise(Buffer packet, int version) {
      int mutations_count = packet.get_unsignedshort();
      packet.get_unsignedbyte();
      this.start_interpolation_type = InterpolationType.lookup_by_id(packet.get_unsignedbyte());
      this.end_interpolation_type = InterpolationType.lookup_by_id(packet.get_unsignedbyte());
      this.interpolate_timing = packet.get_unsignedbyte() != 0;
